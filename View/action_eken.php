...
<body>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/camera/h9r-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">EKEN H9R 4K Wifi Waterproof Action Camera With Remote Control</a></h3>
                                            <div class="ratings">
    ...
    Built-in WiFi
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/camera/h5s-plus-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">EKEN H5s Plus 12MP Ultra HD 4K+ Waterproof Action Camera</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
...
Model: H5s Plus <br>
2-inch Touch Screen + Status Screen<br>
4K+ EIS (Electronic Image Stabilization)<br>
Built-in WiFi<br>
30M Waterproof
