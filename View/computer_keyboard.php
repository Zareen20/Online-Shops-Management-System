                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/accessories/mac-keyboard-1-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Matias Wired Keyboard for Mac</a></h3>
                                            <div class="ratings">
...
High-Precision Volume Dial
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/accessories/surface-pro-type-cover-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Microsoft Surface Pro Type Cover Keyboard - Black</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            Key Features
MPN: FMM-00015 <br>
Model: Microsoft Surface Pro Type Cover Keyboard FMM-15<br>
Supported platforms Surface Pro<br>
Moving (mechanical) keys<br>
Interface Magnetic<br>
