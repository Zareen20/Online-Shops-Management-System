                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">ASUS Computer</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/a4321ukh-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/a4321ukh-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Asus AIO A4321UKH Core i3 7th Gen PC</a></h3>
                                            <div class="ratings">
                                            ...
                                            <p>Key Features
Model: Asus AIO A4321UKH <br>
Intel® Core™ i3-7100U (2.40 GHz,3 MB SmartCache)<br>
4 GB DDR4 Ram<br>
1 TB HDD<br>
19.5" HD Monitor</p>
                        ...
                        <div class="product-list-item mb-30">
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Asus AIO A4321UKH Core i5 7th Gen PC</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">56,000৳</span>
                                                <span class="old-price"><del>58,000৳</del></span>
                                            </div>
                                            <p>Key Features
Model: Asus AIO A4321UKH <br>
Intel® Core i5-7400 (3.00 GHz up to 3.50 GHz)<br>
4 GB DDR4 Ram<br>
1 TB HDD<br>
19.5" HD Monitor</p>
                                            <div class="product-list-action-link">
