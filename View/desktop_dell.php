                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Dell Computer</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                   
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/optiplex-22-3280-core-i3-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/dell-3280-aio-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Dell Inspiron 22 3280 Core i3 21.5" Full HD All In One PC (Black)</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>53,000৳</del></span>
                                            </div>
                                            <p>Key Features
MPN: PUN22WHL2001101 <br>
Model: Dell Inspiron 22 3280<br>
Intel Core i3-8145U (4M Cache, 2.10 GHz up to 3.90 GHz)<br>
4GB DDR4<br>
1TB HDD<br>
Windows 10</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/dell-3280-aio-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/optiplex-22-3280-core-i3-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Dell Optiplex 22 3280 Core i3 10th Gen 21.5" Full HD All In One PC</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <p>Key Features
Model: Dell Optiplex 22 3280 Core  <br>
Intel Core i3-10100T Processor (6M Cache, 3.00 GHz up to 3.80 GHz)<br>
4GB DDR4<br>
1TB HDD<br>
21.5" FHD IPS Display</p>
                                            <div class="product-list-action-link">
                                                <a class="buy-btn" href="admin/product_order.php" data-toggle="tooltip" data-placement="top" title="Add to cart">go to buy <i class="fa fa-shopping-cart"></i> </a>                                               
                                            </div>
                                        </div>
