                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Desktop</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">HP Computer</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                   
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/280-pro-g6-mt-1-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/600g3-500x500-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">HP 280 Pro G6 MT Core i5 10th Gen</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">47,000৳</span>
                                                <span class="old-price"><del>50,000৳</del></span>
                                            </div>
                                            <p>Key Features
Model: HP 280 Pro G6 MT <br>
Intel Core i5-10500 Processor (12M Cache, 3.10 GHz up to 4.50 GHz)<br>
4GB DDR4 RAM-2666MHz RAM<br>
1TB SATA-7200rpm HDD<br>
HP USB Keyboard & Optical Mouse</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/600g3-500x500-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/280-pro-g6-mt-1-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">HP ProDesk 600 G4 MT Core i5 8th Gen</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>52,000৳</del></span>
                                            </div>
                                            <p>Key Features
Model: HP ProDesk 600 G4 MT <br>
Intel 8th Gen Core i5-8500 Processor-3.0GHz<br>
8GB DDR4 RAM-2666MHz<br>
1 TB SATA-7200rpm HDD</p>
                                            <div class="product-list-action-link">
                                                <a class="buy-btn" href="admin/product_order.php" data-toggle="tooltip" data-placement="top" title="Add to cart">go to buy <i class="fa fa-shopping-cart"></i> </a>                                               
                                            </div>
                                        </div>
