                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/camera/ixus-185-500x500.png" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">CANON IXUS 185 20.0 MP 8X OPTICAL ZOOM</a></h3>
                                            <div class="ratings">
                                            ...
                                            <p>
                                            Key Features
Model: Canon IXUS 185 <br>
Image Sensor 1/2.3 type CCD<br>
Image Processor Type DIGIC 4+<br>
5.0–40.0mm f/3.2–f/6.9<br>
8x optical zoom with wide-angle lens
                                            </p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/camera/sx620-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">CANON POWERSHOT SX620 HS 20.2 MP 25X OPTICAL ZOOM</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>27,000৳</del></span>
                                            </div>
                                            <p>
                                            Key Features
Model: Canon PowerShot SX620 <br>
1/2.3-inch CMOS<br>
20.2 Megapixel<br>
Optical Zoom 25x<br>
Lens 25-625mm
