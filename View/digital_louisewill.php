                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">DSLR Camera</a></li>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/f28b63ae3a9d3eaf59bec113e591fe6e.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">LouisWill Fashion Couple Quartz Watches Casual Lovers 30M Waterproof Stainless Steel Wristwatches With adjuster</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>1,400৳</del></span>
                                            </div>
                                            <p>
                                            Code: LouisWill
Original LouisWill Brand Watch <br>
Waterproof.<br>
High-Quality Leather Strap.<br>
1 Years International Warranty
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/9a57455b00c2dcba21c8c50e9cbc149e.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">LouisWill Men Fashion Watch Machinery Quartz Watches Stainless Steel 30M Waterproof Band Calendar Wristwatch</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>3,000৳</del></span>
                                            </div>
                                            <p>
                                            Code: LouisWill
Dial Diameter: 45.5mm; <br>
Dial Thickness: 17mm<br>
Water Resistant (3 ATM)<br>
Feature: Auto Date<br>
Feature: Complete Calendar<br>
