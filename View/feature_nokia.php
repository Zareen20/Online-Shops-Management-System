                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Nokia-216-Blue.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">3,200৳</span>
                                                <span class="old-price"><del>3,500৳</del></span>
                                            </div>
                                            <p>    Body	
Style	Bar Phone
Material	Plastic
Water Resistance	✖
Dimensions	118 x 50.2 x 13.5 millimeters
Weight	 82.6 grams
  Display	
Size	2.4 inches
...
Technology	TFT
  Camera	
Back	0.3 Megapixel (VGA), LED Flash, 2x digital zoom
Front	0.3 Megapixel (VGA), LED Flash
Video Recording	QVGA (320 x 240)
  Battery	
Type and Capacity	Lithium-ion 1020 mAh
...
Talk-time	Up to 18 hours
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Nokia-220-4G.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>4,200৳</del></span>
                                            </div>
                                            <p>Nokia 220 (4G) comes with dual SIM. The main specialty of this phone is that it comes with 4G support. Apps like WhatsApp and Facebook are pre-installed. There is stereo FM radio in this device which is playable with 3.5mm earphone. The display is 2.4 inches. Some basic games are playable in this feature phone. There are also flashlight, loudspeaker, dedicated MicroSD slot, 1200 mAh battery, VGA back camera with flash, video recording, Bluetooth and so on.
