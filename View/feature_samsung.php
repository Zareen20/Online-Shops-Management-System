                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Samsung-Metro-350-Black-1.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Samsung Metro 350</a></h3>
                                            <div class="ratings">
...
Material	Plastic
Water Resistance	✖
Dimensions	117.5 x 51.4 x 11.9 millimeters
Weight	89 grams
  Display	
Size	2.4 inches
...
Technology	TFT
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Samsung-Metro-313-Black-1.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Samsung Metro 313</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">3,000৳</span>
                                                <span class="old-price"><del>3,200৳</del></span>
                                            </div>
                                            <p>  Body	
Style	Bar Phone
Material	Plastic
Water Resistance	✖
Dimensions	112.7 x 46.4 x 13.1 millimeters
Weight	 75.2 grams
  Display	
Size	2.0 inches
Resolution	QQVGA 128 x 160 pixels
Technology	TFT
</p>
                                            <div class="product-list-action-link">
                                                <a class="buy-btn" href="admin/product_order.php" data-toggle="tooltip" data-placement="top" title="Add to cart">go to buy <i class="fa fa-shopping-cart"></i> </a>                                               
