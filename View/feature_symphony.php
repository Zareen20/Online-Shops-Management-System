                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Feature Phone</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Symphony</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Symphony-S40.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>1,500৳</del></span>
                                            </div>
                                            <p>  Symphony S40 comes with a dual SIM options. It comes with up to 200 hours of average standby time with 1100 mAh battery. There is a wireless FM radio in this device. It also has MP3 and MP4 players. The display is 2.4 inches QVGA quality. There is a 0.3 MP back camera, call recorder, battery saver, Bluetooth, GPRS, sound recorder, call recorder, java, internet, flash light or torch, blacklist etc. features in this device.
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Symphony-L42.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>1,200৳</del></span>
                                            </div>
                                            <p>Symphony L42 comes with a dual SIM options. It comes with up to 330 hours of decent standby time with 1700 mAh battery. There is a wireless FM radio in this device. It also has MP3 and MP4 players. The display is 2.4 inches QVGA quality. There is a 0.08 MP back camera, call recorder, battery saver, Bluetooth, GPRS, sound recorder, call recorder, flash light or torch, blacklist etc. features in this device.
