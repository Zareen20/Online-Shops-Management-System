                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Gadget</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/accessories/c-821-3-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Awei C-821 Universal Usb Quick Travel Charging Adapter (2 pin)</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>600৳</del></span>
                                            </div>
                                            <p>
                                            Key Features
Model: Awei C-821 <br>
...
Input:100-240V, Output: 5V-2.0A<br>
Size:86 x36 x 21mm, weight: 30g
                                            </p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/accessories/cpb2-01-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Orico CPB2 Computer Host Bracket with Wheels</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>500৳</del></span>
                                            </div>
                                            <p>
                                            Key Features
MPN: CPB2-BK-BP <br>
Model: CPB2<br>
Strictly Selected ABS Material, Carbon Fiber Surface<br>
Four Caster Wheels, Front wheels with lock<br>
Three-sided baffle bracket<br>
Dimension: 24.6x46.7x4cm
