                                ...
                                <ul class="category-mega-menu">
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="dslr_fujifilm.php">Fujifilm</a></li>                                           
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="digital_nikon.php">Nikon</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children">
                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Dell Laptop</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                   
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/3505-01-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/15-3583-01-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Dell Inspiron 15 3505 Athlon Silver 3050U 15.6" HD Laptop</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">36,000৳</span>
                                                <span class="old-price"><del>40,000৳</del></span>
                                            </div>
                                            <p>Key Features
MPN: BULLN315AMD2105257 <br>
Model: Inspiron 15 3505<br>
AMD Athlon Silver 3050U ( 2.3GHz Up to 3.2GHz )Processor<br>
4GB DDR4 3200mhz RAM<br>
1TB HDD<br>
15.6" HD (1366 x 768) Display</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/15-3583-01-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/3505-01-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
