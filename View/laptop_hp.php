                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">HP Laptop</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/hp-15s-du1088tu-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/15s-001-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">HP 15s-du1088TU Intel Pentium N5030 15.6 inch FHD Laptop</a></h3>
                                            <div class="ratings">
                                            ...
                                            <p>Key Features
MPN: 2R0E0PA<br>
Model: 15s-du1088TU<br>
Intel Pentium Silver 5030 1.10 To 3.10 GHz Processor<br>
4GB DDR4 RAM + 1TB <br>
...
Windows 10 Home</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/15s-001-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/hp-15s-du1088tu-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">HP 15s-du1090tu Core i3 10th Gen 15.6" FHD Laptop</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <p>Key Features
MPN: 2R2H2PA <br>
Model: 15s-du1090tu<br>
Intel Core i3-10110U (2.1 GHz up to 4.1 GHz, 4 MB L3 cache, 2 cores)<br>
4GB DDR4 RAM (1x 4GB)<br>
1TB 5400 rpm SATA <br>
