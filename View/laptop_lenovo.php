                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Lenovo Laptop</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/ideapad-slim-3-04-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/ideapad-slim-3-01-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Lenovo Ideapad Slim 3 AMD Dual Core 3020e 14" HD Laptop</a></h3>
                                            <div class="ratings">
...
AMD Dual Core 3020e (4MB cache and 1.2 GHz upto 2.6 GHz)<br>
4GB DDR4<br>
1TB 5400rpm HDD<br>
14″ HD (1366 × 768) Display</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/desktop/ideapad-slim-3-01-500x500.jpg" class="img-pri" alt="">
                                                <img src="assets/desktop/ideapad-slim-3-04-500x500.jpg" class="img-sec" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Lenovo IdeaPad Slim 3 Ryzen 3 3250U 15.6" FHD Laptop</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>45,000৳</del></span>
                                            </div>
                                            <p>Key Features
MPN: 81W10147IN <br>
Model: IdeaPad Slim <br>
AMD Ryzen 3 3250U (2.6GHz up to 3.5GHz)<br>
4GB DDR4 2666MHz RAM<br>
1TB SATA HDD<br>
15.6" FHD (1920 x 1080) Display</p>
                                            <div class="product-list-action-link">
                                                <a class="buy-btn" href="admin/product_order.php" data-toggle="tooltip" data-placement="top" title="Add to cart">go to buy <i class="fa fa-shopping-cart"></i> </a>                                               
                                            </div>
                                        </div>
