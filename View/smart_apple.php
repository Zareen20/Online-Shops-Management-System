...
<body>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/apple-watch-se-01-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Apple Watch SE (MYDN2LL/A) GPS 40mm Sport Band (Gold Aluminum, Pink Sand)</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>33,000৳</del></span>
                                            </div>
                                            <p>
                                            Key Features

    MPN: MYDN2LL/A <br>
    Model: Apple Watch SE<br>
    ...
    Heart Rate Monitor with Notifications
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/series-6-red-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Apple Watch Series 6 44mm Sport Band (Red)</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
    ...
    Model: Series 6 <br>
    LTPO OLED Always-On Retina Display<br>
    Fall Detection + SOS Emergency<br>
    Water-Resistant up to 164'<br>
