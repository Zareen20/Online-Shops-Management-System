                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/watch-fit-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Huawei Watch Fit 1.64" Vivid AMOLED Display with Quick-Workout Animations</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>11,000৳</del></span>
                                            </div>
                                            <p>
                                            Key Features

MPN: TIA-B09 <br>
Model: Huawei Watch Fit<br>
326 PPI<br>
1.64 inch display<br>
2.5D curved glass<br>
280 x 456 HD resolution
                                            </p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/gt2-sports-edition-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Huawei Watch GT 2 (Sports Edition)</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>18,000৳</del></span>
                                            </div>
                                            <p>
                                            Key Features

    Model: Huawei Watch GT 2 <br>
    AMOLED Touchscreen<br>
