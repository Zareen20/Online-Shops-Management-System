...
<body>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/haylou-ls02-500x500.jpeg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Xiaomi Haylou LS02 Touch Screen Square Shape Smart Watch Black</a></h3>
                                            <div class="ratings">
                                            ...
                                            <div class="pricebox">
                                                ...
                                                <span class="old-price"><del>6,000৳</del></span>
                                            </div>
                                            <p>
                                            Key Features

    MPN: 3128298 <br>
    Model: Xiaomi Haylou LS02<br>
    12 sports modes<br>
    20 days of endurance<br>
    Intelligent sleep monitoring<br>
    Real-time heart rate monitoring
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/watch/haylou-solar-ls05-1-001-500x500.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Xiaomi Haylou Solar LS05-1 Smart Watch Black</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
    ...
    Model: Haylou Solar LS05-1 <br>
    1.28 Inch Round TFT Screen<br>
    Real-time Heart Rate Monitor<br>
    IP68 Waterproof, Metal Body<br>
