                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Tab</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">                                    
                                    ...
                                    <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Samsung-Galaxy-Tab-S5e.jpg" class="img-pri" alt="">
                                            </a>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Samsung Galaxy Tab S5e</a></h3>
                                            <div class="ratings">
                                            ...
                                            <p>Samsung Galaxy Tab S5e features 10.5 inches display, 2GHz, 1.7GHz Octa-Core processor, 4GB RAM + 64GB ROM (internal memory), 13 + 8 MP camera, 7040 mAh Battery etc.
</p>
                        ...
                        <div class="product-list-item mb-30">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img src="assets/mobile/Samsung-Galaxy-A-Tab-10.1-Black.jpg" class="img-pri" alt="">
                                            </a>
                                            <div class="product-label">
                                                <span>hot</span>
                                            </div>
                                        ...
                                        <div class="product-list-content">
                                            <h3><a href="#">Samsung Galaxy A Tab 10.1</a></h3>
                                            <div class="ratings">
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                                <span class="good"><i class="fa fa-star"></i></span>
                                            ...
                                            <div class="pricebox">
                                                <span class="regular-price">33,000৳</span>
                                                <span class="old-price"><del>35,000৳</del></span>
                                            </div>
                                            <p>Samsung Galaxy A Tab 10.1 features 10.1 inches display, 1.8 GHz Dual +1.6GHz Hexa, Octa Core processor, 2GB RAM + 32GB ROM (internal memory), 8 + 5 MP camera, 6150 mAh Battery etc.
